...
/**
 * IMGT/HLA version 3.33.0 nomenclature.
 */
public final class ImgtHla3_33_0 extends ClasspathNomenclature {

    @Inject
    public ImgtHla3_33_0(final GlstringResolver glstringResolver,
                         final IdResolver idResolver,
                         final GlRegistry glRegistry) {
        super("imgt-hla-3.33.0.txt", glstringResolver, idResolver, glRegistry);
    }
